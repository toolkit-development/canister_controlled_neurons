...
impl IcpGovernanceApi {
    ...
    pub async fn get_most_recent_monthly_node_provider_rewards(
        &self,
    ) -> Result<(Option<MonthlyNodeProviderRewards>,)> {
    ...
    pub async fn get_neuron_index(
        &self,
        arg0: GetNeuronIndexRequest,
    ) -> Result<(GetNeuronIndexResult,)> {
    ...
    pub async fn list_neuron_votes(
        &self,
        arg0: ListNeuronVotesRequest,
    ) -> Result<(ListNeuronVotesResponse,)> {
